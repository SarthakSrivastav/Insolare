(function() {
    ...
    */
    ...
    var pg = {},
        ...
        rg = {},
        sg = (rg.AUTH_INVALID = "ERROR", rg.EXECUTE_TRANSACTION_ON_CLOSED_DB = "WARNING", rg.EXPLICIT_ABORT = "IGNORED", rg.IDB_NOT_SUPPORTED = "WARNING", rg.MISSING_OBJECT_STORE = "ERROR", rg.QUOTA_EXCEEDED = "WARNING", rg.QUOTA_MAYBE_EXCEEDED = "WARNING", rg.UNKNOWN_ABORT = "WARNING", rg);
                    ...
                    if (!(F.message && 0 < F.message.indexOf("target origin ''"))) {
                        ...
                        if (e) {
                            ...
                            if (!(5 <= Dh)) {
                                ...
                                e.params["params.fscripts"] = String(document.querySelectorAll("script:not([nonce])").length);
                                ...
                                if (!Ch.has(e.message) && !f) {
                                    ...
                                    })), Eh++) : "WARNING" === d && wh.J("handleWarning", e);
                                    ...
                                    if (!S("suppress_error_204_logging")) {
                                        ...
                                        if (d.postParams) {
                                            g.stack && (d.postParams.stack = g.stack);
                                            g = u(Object.keys(f));
                                            for (h = g.next(); !h.done; h = g.next()) h = h.value,
                                                d.postParams["client." + h] = f[h];
