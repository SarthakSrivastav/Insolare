    ...
    */
    ...
    function ta(a, b, c, d) {
        try {
            ...
            return a.h.i = null, pa(a.h, g), ua(a)
        }
        a.h.i = null;
        d.call(a.h, f);
        return ua(a)
    ...
    function va(a) {
        this.next = function(b) {
            oa(a.h);
            a.h.i ? b = ta(a, a.h.i.next, b, a.h.s) : (a.h.s(b), b = ua(a));
            return b
        };
        this["throw"] = function(b) {
            oa(a.h);
            a.h.i ? b = ta(a, a.h.i["throw"], b, a.h.s) : (pa(a.h, b), b = ua(a));
            return b
        };
    ...
    t("Promise", function(a) {
        ...
        b.race = function(g) {
            return new b(function(h, k) {
                for (var l = u(g), m = l.next(); !m.done; m = l.next()) d(m.value).O(h, k)
            })
        };
        b.all = function(g) {
            var h = u(g),
    ...
    t("Map", function(a) {
        ...
        e.prototype.set = function(h, k) {
            ...
            l.v ? l.v.value = k : (l.v = {
                ...
                key: h,
                value: k
            }, l.list.push(l.v), this.h.previous.next = l.v, this.h.previous = l.v, this.size++);
            return this
        };
        e.prototype["delete"] = function(h) {
            h = d(this, h);
            return h.v && h.list ? (h.list.splice(h.index, 1), h.list.length || delete this.i[h.id], h.v.previous.next = h.v.next, h.v.next.previous = h.v.previous, h.v.head = null, this.size--, !0) : !1
        };
    ...
    function Ka() {
        var a = /[?&]dsh=1(&|$)/.test("/generate_204");
        this.j = !a && /[?&]ae=1(&|$)/.test("/generate_204");
        this.l = !a && /[?&]ae=2(&|$)/.test("/generate_204");
        if ((this.h = /[?&]adurl=([^&]*)/.exec("/generate_204")) && this.h[1]) {
            try {
                var b = decodeURIComponent(this.h[1])
            } catch (c) {
                b = null
            }
            this.i = b
    ...
    var wb = J("Opera"),
        xb = J("Trident") || J("MSIE"),
        yb = J("Edge"),
        zb = J("Gecko") && !(-1 != I.toLowerCase().indexOf("webkit") && !J("Edge")) && !(J("Trident") || J("MSIE")) && !J("Edge"),
        Ab = -1 != I.toLowerCase().indexOf("webkit") && !J("Edge");
    ...
    a: {
        var Db = "",
            Eb = function() {
                ...
                if (xb) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);
                if (Ab) return /WebKit\/(\S+)/.exec(a);
                if (wb) return /(?:Version)[ \/]?(\S+)/.exec(a)
            }();
        Eb && (Db = Eb ? Eb[1] : "");
        if (xb) {
            var Fb = Bb();
    ...
    var Jb = Hb;
    var Kb = J("Firefox") || J("FxiOS"),
        Lb = ub() || J("iPod"),
        Mb = J("iPad"),
        Nb = J("Safari") && !((J("Chrome") || J("CriOS")) && !J("Edge") || J("Coast") || J("Opera") || J("Edge") || J("Edg/") || J("OPR") || J("Firefox") || J("FxiOS") || J("Silk") || J("Android")) && !(ub() || J("iPad") || J("iPod"));
    var Ob = {},
        Pb = null;
    var M = window;
    ...
    var Ub = {
            wa: "allow-forms",
            xa: "allow-modals",
            ya: "allow-orientation-lock",
            za: "allow-pointer-lock",
            Aa: "allow-popups",
            Ba: "allow-popups-to-escape-sandbox",
            Ca: "allow-presentation",
            Da: "allow-same-origin",
            Ea: "allow-scripts",
            Fa: "allow-top-navigation",
            Ga: "allow-top-navigation-by-user-activation"
        },
        Wb = La(function() {
            return Vb()
        });
    ...
    function $b(a) {
        if (a !== Zb) throw Error("Bad secret");
    };
        ...
        if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
            ...
            if (null ==
                ...
                if (a.constructor && a.constructor instanceof Function) {
                    ...
                    else if (c = a.constructor, nc[c]) c = nc[c];
                    else {
                        c = String(c);
                        if (!nc[c]) {
    ...
    r.clear = function() {
        for (var a = (this.h.cookie || "").split(";"), b = [], c = [], d, e, f = 0; f < a.length; f++) e = ab(a[f]), d = e.indexOf("="), -1 == d ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
    ...
    function tc() {
            ...
            for (q = 0; 80 > q; q++) {
                if (40 > q)
                    if (20 > q) {
                        var ha = y ^ v & (w ^ y);
                        var ib = 1518500249
                    } else ha = v ^ w ^ y, ib = 1859775393;
                else 60 > q ? (ha = v & w | y & (v | w), ib = 2400959708) : (ha = v ^ w ^ y, ib = 3395469782);
                ha = ((n << 5 | n >>> 27) & 4294967295) + ha + F + ib + p[q] & 4294967295;
                F = y;
                y = w;
        ...
        function c(n, p) {
            if ("string" === typeof n) {
                ...
                for (var q = [], v = 0, w = n.length; v < w; ++v) q.push(n.charCodeAt(v));
                n = q
            }
            p || (p = n.length);
            q = 0;
        ...
        function d() {
            ...
            b(f);
            for (q = p = 0; 5 > q; q++)
                for (var v = 24; 0 <= v; v -= 8) n[p++] = e[q] >> v & 255;
            return n
        }
    ...
    function uc(a, b, c) {
        ...
        return d && a && b ? [b, vc(sc(d), a, c || null)].join(" ") : null
    }
    ...
    function yc(a) {
        return !!xc.FPA_SAMESITE_PHASE2_MOD || !(void 0 === a || !a)
    }

    function zc(a, b, c, d) {
        (a = B[a]) || (a = (new pc(document)).get(b));
        return a ? uc(a, c, d) : null
    }

    function Ac(a) {
        var b = void 0 === b ? !1 : b;
        var c = sc(String(B.location.href)),
            d = [];
        var e = b;
        e = void 0 === e ? !1 : e;
        var f = B.__SAPISID || B.__APISID || B.__3PSAPISID || B.__OVERRIDE_SID;
        yc(e) && (f = f || B.__1PSAPISID);
        if (f) e = !0;
        else {
            var g = new pc(document);
            f = g.get("SAPISID") || g.get("APISID") || g.get("__Secure-3PAPISID") || g.get("SID");
            yc(e) && (f = f || g.get("__Secure-1PAPISID"));
            e = !!f
        }
        e && (e = (c = 0 == c.indexOf("https:") || 0 == c.indexOf("chrome-extension:") || 0 == c.indexOf("moz-extension:")) ? B.__SAPISID : B.__APISID, e || (e = new pc(document),
            e = e.get(c ? "SAPISID" : "APISID") || e.get("__Secure-3PAPISID")), (e = e ? uc(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e), c && yc(b) && ((b = zc("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) && d.push(b), (a = zc("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) && d.push(a)));
    ...
    function Cc(a) {
        -1 == a.i && (a.i = Na(a.h, function(b, c, d) {
    ...
    Sc.prototype.update = function(a, b) {
        if (null != a) {
            void 0 === b && (b = a.length);
            for (var c = b - this.i, d = 0, e = this.o, f = this.j; d < b;) {
                if (0 == f)
                    for (; d <= c;) Tc(this, a, d), d += this.i;
                if ("string" === typeof a)
                    for (; d < b;) {
    ...
    var Uc = "StopIteration" in B ? B.StopIteration : {
    ...
    function Zc(a, b) {
        ...
        if (1 < c) {
            ...
            if (a instanceof Zc)
                for (c = $c(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
            else
    ...
    r.clear = function() {
        this.i = {};
        this.l = this.j = this.h.length = 0
    };
    r.remove = function(a) {
        return Object.prototype.hasOwnProperty.call(this.i, a) ? (delete this.i[a], this.j--, this.l++, this.h.length > 2 * this.j && ad(this), !0) : !1
    };
    ...
    r.set = function(a, b) {
        Object.prototype.hasOwnProperty.call(this.i, a) || (this.j++, this.h.push(a), this.l++);
        this.i[a] = b
    };
    r.forEach = function(a, b) {
        for (var c = $c(this), d = 0; d < c.length; d++) {
            var e = c[d],
                f = this.get(e);
            a.call(b, f, e, this)
        }
    ...
    var cd = function() {
        ...
        try {
            B.addEventListener("test", Aa, b), B.removeEventListener("test", Aa, b)
        } catch (c) {}
        return a
    }();
    ...
    ed.prototype.init = function(a, b) {
        ...
        this.state = a.state;
        this.i = a;
        a.defaultPrevented && ed.A.preventDefault.call(this)
    };
    ...
    kd.prototype.add = function(a, b, c, d, e) {
        ...
        var g = ld(a, b, d, e); - 1 < g ? (b = a[g], c || (b.N = !1)) : (b = new id(b, this.src, f, !!d, e), b.N = c, a.push(b));
        return b
    };
    kd.prototype.remove = function(a, b, c, d) {
        ...
        b = ld(e, b, c, d);
        return -1 < b ? (jd(e[b]), Array.prototype.splice.call(e, b, 1), 0 == e.length && (delete this.listeners[a], this.h--), !0) : !1
    };

    function md(a, b) {
        var c = b.type;
        c in a.listeners && Pa(a.listeners[c], b) && (jd(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.h--))
    }

    function ld(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.L && f.listener == b && f.capture == !!c && f.P == d) return e
        }
        return -1
    };
    ...
    function qd(a, b, c, d, e) {
        ...
        else c = sd(c), a && a[gd] ? td(a, b, c, D(d) ? !!d.capture : !!d, e) : ud(a, b, c, !1, d, e)
    }
    ...
    function rd(a, b, c, d, e) {
        ...
        else c = sd(c), a && a[gd] ? a.h.add(String(b), c, !0, D(d) ? !!d.capture : !!d, e) : ud(a, b, c, !0, d, e)
    }

    function zd(a, b, c, d, e) {
        if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) zd(a, b[f], c, d, e);
        else(d = D(d) ? !!d.capture : !!d, c = sd(c), a && a[gd]) ? a.h.remove(String(b), c, d, e) : a && (a = vd(a)) && (b = a.listeners[b.toString()], a = -1, b && (a = ld(b, c, d, e)), (c = -1 < a ? b[a] : null) && Ad(c))
    }
    ...
    function Ad(a) {
        if ("number" !== typeof a && a && !a.L) {
            ...
            if (b && b[gd]) md(b.h, a);
                ...
                pd--;
                (c = vd(b)) ? (md(c, a), 0 == c.h && (c.src = null, b[nd] = null)) : jd(a)
            }
        }
    }
    ...
    function Cd(a, b) {
        ...
        e = b;
        var f = e.type || e;
        if ("string" === typeof e) e = new dd(e, c);
        else if (e instanceof dd) e.target = e.target || c;
        else {
            var g = e;
            e = new dd(f, c);
            Za(e, g)
        ...
        e.j || (k = e.h = c, g = Dd(k, f, !0, e) && g, e.j || (g = Dd(k, f, !1, e) && g));
        if (d)
            for (h = 0; !e.j && h < d.length; h++) k = e.h = d[h], g = Dd(k, f, !1, e) && g
    }
    ...
    O.prototype.then = function(a, b, c) {
        return Jd(this, "function" === typeof a ? a : null, "function" === typeof b ? b : null, c)
    };
        ...
        if (0 == a.h)
            if (a.j) {
                ...
                if (c.i) {
                    ...
                    e && (0 == c.h && 1 == d ? Ld(c, b) : (f ? (d = f, d.next == c.l && (c.l = d), d.next = d.next.next) : Md(c), Nd(c, e, 3, b)))
                }
                a.j = null
            } else Fd(a, 3, b)
    }
    ...
    function Jd(a, b, c, d) {
        ...
        e.h = new O(function(f, g) {
            ...
            e.onRejected = c ? function(h) {
                try {
                    var k = c.call(d, h);
                    void 0 === k && h instanceof Kd ? g(h) : f(k)
                } catch (l) {
                    g(l)
                }
            } : g
    ...
    function Fd(a, b, c) {
        if (0 == a.h) {
            ...
            g || (a.s = c, a.h = b, a.j = null, Pd(a), 3 != b || c instanceof Kd || Rd(a, c))
        }
    }
    ...
    O.prototype.u = function() {
        for (var a; a = Md(this);) Nd(this, a, this.h, this.s);
        this.o = !1
    };
    ...
    function Nd(a, b, c, d) {
        ...
        if (b.h) b.h.j = null, Sd(b, c, d);
        else try {
            b.j ? b.i.call(b.context) : Sd(b, c, d)
        } catch (e) {
            Td.call(null, e)
        }
        Ec(Hd, b)
    ...
    r.M = function(a) {
        ...
        if (b) {
            var c = this.i[b];
            0 != this.o ? (this.l.push(a), this.h[a + 1] = Aa) : (c && Pa(c, a), delete this.h[a], delete this.h[a + 1], delete this.h[a + 2])
        }
        return !!b
    };
    r.J = function(a, b) {
    ...
    r.clear = function(a) {
        if (a) {
            var b = this.i[a];
            b && (H(b, this.M, this), delete this.i[a])
    ...
    Xd.prototype.set = function(a, b) {
        void 0 === b ? this.h.remove(a) : this.h.set(a, Ed(b))
    };
    ...
    function $d(a) {
        return void 0 === a || a instanceof Zd ? a : new Zd(a)
    }
    Yd.prototype.set = function(a, b) {
        Yd.A.set.call(this, a, $d(b))
    };
    Yd.prototype.i = function(a) {
        a = Yd.A.get.call(this, a);
    ...
    ae.prototype.set = function(a, b, c) {
        ...
        ae.A.set.call(this, a, b)
    };
    ae.prototype.i = function(a) {
        var b = ae.A.i.call(this, a);
        if (b) {
            var c = b.creation,
                d = b.expiration;
            if (d && d < Date.now() || c && c > Date.now()) ae.prototype.remove.call(this, a);
            else return b
        }
    };
    ...
    function fe(a, b) {
        ...
        if (xb && !(9 <= Number(Jb))) {
            ge || (ge = new Zc);
            this.h = ge.get(a);
            this.h || (b ? this.h = document.getElementById(b) : (this.h = document.createElement("userdata"), this.h.addBehavior("#default#userData"), document.body.appendChild(this.h)), ge.set(a, this.h));
            try {
                this.h.load(this.i)
            } catch (c) {
                this.h = null
    ...
    r.set = function(a, b) {
        this.h.setAttribute(ie(a), b);
        je(this)
    };
    r.get = function(a) {
        a = this.h.getAttribute(ie(a));
        if ("string" !== typeof a && null !== a) throw "Storage mechanism: Invalid value was encountered";
        return a
    };
    r.remove = function(a) {
        this.h.removeAttribute(ie(a));
        je(this)
    };
    r.C = function(a) {
        var b = 0,
    ...
    var le = window.yt && window.yt.config_ || window.ytcfg && window.ytcfg.data_ || {};
    E("yt.config_", le);

    function me(a) {
        var b = arguments;
        1 < b.length ? le[b[0]] = b[1] : 1 === b.length && Object.assign(le, b[0])
    }

    function Q(a, b) {
        return a in le ? le[a] : b
    };
    var ne = [];
    ...
    function qe(a) {
        ...
        b ? b(a, "ERROR", void 0, void 0, void 0) : (b = Q("ERRORS", []), b.push([a, "ERROR", void 0, void 0, void 0]), me("ERRORS", b))
    }

    function re(a) {
        var b = C("yt.logging.errors.log");
        b ? b(a, "WARNING", void 0, void 0, void 0) : (b = Q("ERRORS", []), b.push([a, "WARNING", void 0, void 0, void 0]), me("ERRORS", b))
    };
    var se = 0;
    ...
    function ue(a) {
        ...
        try {
            if (a = a || window.event) {
                this.event = a;
                for (var b in a) b in te || (this[b] = a[b]);
    ...
    ue.prototype.stopImmediatePropagation = function() {
    ...
    var ve = B.ytEventsEventsCounter || {
        count: 0
    };
    E("ytEventsEventsCounter", ve);
        ...
        a && ("string" == typeof a && (a = [a]), H(a, function(b) {
            if (b in Va) {
                var c = Va[b],
                    ...
                    f = c[3];
                c = c[4];
                d.removeEventListener ? ye() || "boolean" === typeof c ? d.removeEventListener(e, f, c) : d.removeEventListener(e, f, !!c.capture) : d.detachEvent && d.detachEvent("on" + e, f);
                delete Va[b]
            }
        }))
    }
    ...
    function ze(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                var g = f ? function(h) {
                    h = new ue(h);
                    if (!Sb(h.relatedTarget, function(k) {
                            return k == a
                ...
                g = pe(g);
                a.addEventListener ? ("mouseenter" == b && f ? b = "mouseover" : "mouseleave" == b && f ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), ye() || "boolean" === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
                Va[e] = [a, b, c, g, d]
            }
        }
    };
    ...
    function Ee(a, b) {
        for (var c = a.split(b), d = {}, e = 0, f = c.length; e < f; e++) {
            ...
            if (1 == g.length && g[0] || 2 == g.length) try {
                var h = Fe(g[0] || ""),
                    k = Fe(g[1] || "");
                h in d ? Array.isArray(d[h]) ? Sa(d[h], k) : d[h] = [d[h], k] : d[h] = k
            } catch (p) {
                var l = p,
                    m = g[0],
                    n = String(Ee);
                l.args = [{
                    ...
                    value: g[1],
                    query: a,
                    method: Ge == n ? "unchanged" : n
                }];
                De.hasOwnProperty(m) || re(l)
            }
        }
        return d
    }
    ...
    function Fe(a) {
        return a && a.match(Ce) ? a : decodeURIComponent(a.replace(/\+/g, " "))
    };
    var Ke = {};

    function Le(a) {
        return Ke[a] || (Ke[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
    ...
    function Pe() {
        for (var a = u(Ne), b = a.next(); !b.done; b = a.next()) b = b.value, b()
    }

    function Qe(a, b) {
        var c;
        "yt:" == a.tagName.toLowerCase().substr(0, 3) ? c = a.getAttribute(b) : c = a ? a.dataset ? a.dataset[Le(b)] : a.getAttribute("data-" + b) : null;
        return c
    }

    function Re(a, b) {
        Vd.J.apply(Vd, arguments)
    };
    ...
    function Te(a, b, c) {
        Ue || (Ue = {}, ze(window, "message", Ha(a.l, a)));
        Ue[c] = b
    }
    Se.prototype.l = function(a) {
        if (a.origin == R(this, "host") || a.origin == R(this, "host").replace(/^http:/, "https:")) {
            ...
            if (a = Ue[b.id]) a.u = !0, a.u && (H(a.s, a.T, a), a.s.length = 0), a.ba(b)
        }
    };
    var Ue = null;
    ...
    function Ze(a, b, c) {
        ...
        return d ? d(a, b, c) : void 0 === c ? (a(), NaN) : Ae(a, c || 0)
    }
    ...
    function bf(a) {
        ...
        e.u_his = h;
        e.u_java = !!M.navigator && "unknown" !== typeof M.navigator.javaEnabled && !!M.navigator.javaEnabled && M.navigator.javaEnabled();
        M.screen && (e.u_h = M.screen.height, e.u_w = M.screen.width,
            e.u_ah = M.screen.availHeight, e.u_aw = M.screen.availWidth, e.u_cd = M.screen.colorDepth);
        M.navigator && M.navigator.plugins && (e.u_nplug = M.navigator.plugins.length);
        M.navigator && M.navigator.mimeTypes && (e.u_nmime = M.navigator.mimeTypes.length);
        h = b.h;
        try {
            var k = h.screenX;
            var l = h.screenY
        ...
        try {
            ...
            var y = (new Qb(w.clientWidth, w.clientHeight)).round()
        } catch (F) {
            y = new Qb(-12245933, -12245933)
        }
        v = y;
        y = {};
        w = new Bc;
        ...
        b = (y.vis = {
            ...
            preview: 4,
            unloaded: 5
        }[b.visibilityState || b.webkitVisibilityState || b.mozVisibilityState || ""] || 0, y.wgl = !!M.WebGLRenderingContext, y);
        c = d.call(c, e, b);
        c.ca_type = "image";
        a && (c.bid = a);
        return c
    ...
    var df = "XMLHttpRequest" in B ? function() {
    ...
    var ff = {
        ...
        gf = "app debugcss debugjs expflag force_ad_params force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address client_dev_root_url".split(" "),
        hf = !1;

    function jf(a, b) {
        b = void 0 === b ? {} : b;
        if (!c) var c = window.location.href;
        var d = a.match(K)[1] || null,
            e = L(a);
        d && e ? (d = c, c = a.match(K), d = d.match(K), c = c[3] == d[3] && c[1] == d[1] && c[4] == d[4]) : c = e ? L(c) == e && (Number(c.match(K)[4] || null) || null) == (Number(a.match(K)[4] || null) || null) : !0;
        d = S("web_ajax_ignore_global_headers_if_set");
        for (var f in ff) e = Q(ff[f]), !e || !c && L(a) || d && void 0 !== b[f] || (b[f] = e);
        if (c || !L(a)) b["X-YouTube-Utc-Offset"] = String(-(new Date).getTimezoneOffset());
        (c || !L(a)) && (f = "undefined" != typeof Intl ? (new Intl.DateTimeFormat).resolvedOptions().timeZone :
            null) && (b["X-YouTube-Time-Zone"] = f);
        if (c || !L(a)) b["X-YouTube-Ad-Signals"] = He(bf(void 0));
        return b
    }
    ...
    function lf(a, b) {
        if (window.fetch && "XML" != b.format) {
                ...
                if (!e) {
                    ...
                    var h = g.ok,
                        k = function(l) {
                            ...
                            b.onFinish && b.onFinish.call(m, l, g)
                        };
            ...
            b.onFetchTimeout && 0 < b.timeout && (f = Ae(function() {
                e || (e = !0, window.clearTimeout(f), b.onFetchTimeout.call(b.context || B))
            }, b.timeout))
        } else of(a, b)
    }
        ...
        var d = nf(a, b),
            ...
            f = pf(a, function(k) {
                if (!e) {
                    ...
                    if (l || n || p) m = qf(a, c, k, b.convertToSafeHtml);
    ...
    function nf(a, b) {
        var c = Q("XSRF_FIELD_NAME", void 0),
            ...
            e = b.postBody || "",
            f = b.postParams,
            g = Q("XSRF_FIELD_NAME", void 0),
            h;
        b.headers && (h = b.headers["Content-Type"]);
        b.excludeXsrf || L(a) && !b.withCredentials && L(a) != document.location.hostname || "POST" != b.method || h && "application/x-www-form-urlencoded" != h || b.postParams && b.postParams[g] || (f || (f = {}), f[c] = d);
        f && "string" === typeof e && (e = Ie(e), Za(e, f), e = b.postBodyFormat && "JSON" == b.postBodyFormat ? JSON.stringify(e) : qb(e));
        if (!(c = e) && (c = f)) {
            a: {
                for (var k in f) {
                    f = !1;
            ...
            c = !f
        }!hf && c && "POST" != b.method && (hf = !0, qe(Error("AJAX request with postData should use POST")));
        return e
    }
        ...
        switch (b) {
            case "JSON":
                try {
                    ...
                    throw d = Error("Error reading responseText"), d.params = a, re(d), g;
                }
                a = c.getResponseHeader("Content-Type") || "";
                f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f));
                break;
            case "XML":
                if (a = (a = c.responseXML) ? rf(a) : null) e = {}, H(a.getElementsByTagName("*"), function(g) {
                    e[g.tagName] = sf(g)
                })
        }
        d && tf(e);
    ...
    function pf(a, b, c, d, e, f, g) {
        function h() {
            4 == (k && "readyState" in k ? k.readyState : 0) && b && pe(b)(k)
        }
        c = void 0 === c ? "GET" : c;
        d = void 0 === d ? "" : d;
        var k = ef();
        ...
        S("debug_forward_web_query_parameters") && (a = kf(a));
        k.open(c, a, !0);
        f && (k.responseType = f);
    ...
    function xf() {
        var a = void 0 === a ? "" : a;
        if (!yf(a))
            if (a = void 0 === a ? "" : a) pf("/generate_204", void 0, "POST", a, void 0);
            else if (Q("USE_NET_AJAX_FOR_PING_TRANSPORT", !1)) pf("/generate_204", void 0, "GET", "", void 0);
        else {
            a: {
                try {
                    var b = new Ka;
                    if (b.j && b.i || b.l) {
                        var c = nb("/generate_204".match(K)[5] || null);
                        var d = !(!c || !c.endsWith("/aclk") || "1" !== sb("/generate_204", "ri"));
                        break a
                    }
                } catch (e) {}
                d = !1
    ...
    function yf(a) {
        try {
            if (window.navigator && window.navigator.sendBeacon && window.navigator.sendBeacon("/generate_204", void 0 === a ? "" : a)) return !0
        } catch (b) {}
        return !1
    }
    ...
    var Af = B.ytPubsubPubsubInstance || new P,
        Bf = B.ytPubsubPubsubSubscribedKeys || {},
        Cf = B.ytPubsubPubsubTopicToKeys || {},
        Df = B.ytPubsubPubsubIsSynchronous || {};
    P.prototype.subscribe = P.prototype.subscribe;
    P.prototype.unsubscribeByKey = P.prototype.M;
    P.prototype.publish = P.prototype.J;
    P.prototype.clear = P.prototype.clear;
    E("ytPubsubPubsubInstance", Af);
    E("ytPubsubPubsubTopicToKeys", Cf);
    E("ytPubsubPubsubIsSynchronous", Df);
    E("ytPubsubPubsubSubscribedKeys", Bf);
    var Ef = window,
        T = Ef.ytcsi && Ef.ytcsi.now ? Ef.ytcsi.now : Ef.performance && Ef.performance.timing && Ef.performance.now && Ef.performance.timing.navigationStart ? function() {
            return Ef.performance.timing.navigationStart + Ef.performance.now()
        } : function() {
            return (new Date).getTime()
        };
    var Ff = We("initial_gel_batch_timeout", 1E3),
        Gf = Math.pow(2, 16) - 1,
        Hf = null,
        If = 0,
        Jf = void 0,
        ...
        Mf = 0,
        Nf = !0,
        Of = B.ytLoggingTransportGELQueue_ || new Map;
    E("ytLoggingTransportGELQueue_", Of);
    var Pf = B.ytLoggingTransportTokensToCttTargetIds_ || {};
    E("ytLoggingTransportTokensToCttTargetIds_", Pf);

    function Qf(a, b) {
        if ("log_event" === a.endpoint) {
            var c = "";
            a.B && (Pf[a.B.token] = Rf(a.B), c = a.B.token);
            var d = Of.get(c) || [];
            Of.set(c, d);
            d.push(a.payload);
            b && (Jf = new b);
            c = We("web_logging_max_batch") || 100;
            var e = T();
            d.length >= c ? Sf({
                writeThenSend: !0
            }) : 10 <= e - Mf && (Tf(), Mf = e)
    ...
    function Sf(a) {
        ...
        return new O(function(b) {
            window.clearTimeout(Kf);
            window.clearTimeout(Lf);
            Lf = 0;
            Jf && Jf.isReady() ? (Vf(Of, b, a), Of.clear()) : (Tf(), b())
        })
    }

    function Tf() {
        S("web_gel_timeout_cap") && !Lf && (Lf = Ae(Sf, 6E4));
        window.clearTimeout(Kf);
        var a = Q("LOGGING_BATCH_TIMEOUT", We("web_gel_debounce_ms", 1E4));
        S("shorten_initial_gel_batch_timeout") && Nf && (a = Ff);
        Kf = Ae(function() {
            Sf({
                writeThenSend: !0
            })
    ...
    function Vf(a, b, c) {
        ...
        for (var g = a.next(); !g.done; g = a.next()) {
            ...
            delete Pf[g];
            Zf(h, e);
            S("send_beacon_before_gel") && window.navigator && window.navigator.sendBeacon && !c.writeThenSend && xf();
            $f(d, "log_event", h, {
                retry: !0,
                onSuccess: function() {
                    f--;
    ...
    function Zf(a, b) {
        ...
        var c = Q("EVENT_ID", void 0);
        if (c) {
            var d = Q("BATCH_CLIENT_COUNTER", void 0) || 0;
            !d && S("web_client_counter_random_seed") && (d = Math.floor(Math.random() * Gf / 2));
            d++;
            d > Gf && (d = 1);
            me("BATCH_CLIENT_COUNTER", d);
            c = {
                serializedEventId: c,
                clientCounter: String(d)
            };
            a.serializedClientEventId = c;
            Hf && If && S("log_gel_rtt_web") && (a.previousBatchInfo = {
                serializedClientEventId: Hf,
                roundtripMs: String(If)
            });
            Hf = c;
            If = 0
        }
    ...
    var ag = B.ytLoggingGelSequenceIdObj_ || {};
    E("ytLoggingGelSequenceIdObj_", ag);
    ...
    function cg() {
        return "INNERTUBE_API_KEY" in le && "INNERTUBE_API_VERSION" in le
    }
    ...
    function Xf() {
        return {
            ...
            ka: Q("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
            la: Q("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
            innertubeContextClientVersion: Q("INNERTUBE_CONTEXT_CLIENT_VERSION", void 0),
            na: Q("INNERTUBE_CONTEXT_HL", void 0),
            ma: Q("INNERTUBE_CONTEXT_GL", void 0),
            oa: Q("INNERTUBE_HOST_OVERRIDE", void 0) || "",
            qa: !!Q("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
            pa: !!Q("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
    ...
    function Wf(a) {
        ...
        c = [];
        var d = Q("EXPERIMENTS_FORCED_FLAGS", {});
        for (e in d) c.push({
            key: e,
            value: String(d[e])
        });
        var e = Q("EXPERIMENT_FLAGS", {});
        ...
        if (S("web_log_connection_in_gel")) {
            a: {
                if (f = (a = B.navigator) ? a.connection : void 0) {
                    a = bg[f.type || "unknown"] || "CONN_UNKNOWN";
                    f = bg[f.effectiveType || "unknown"] || "CONN_UNKNOWN";
        ...
        e = b.client;
        c = {};
        d = u(Object.entries(Ie(Q("DEVICE", ""))));
    ...
    function dg(a, b, c) {
        ...
        (b = c.Ia || Q("AUTHORIZATION")) || (a ? b = "Bearer " + C("gapi.auth.getToken")().Ha : b = Ac([]));
    ...
    function fg(a) {
        var b = new ee;
        (b = b.isAvailable() ? a ? new ke(b, a) : b : null) || (a = new fe(a || "UserDataSharedStore"), b = a.isAvailable() ? a : null);
        this.h = (a = b) ? new ae(a) : null;
        this.i = document.domain || window.location.hostname
    }
    fg.prototype.set = function(a, b, c, d) {
        c = c || 31104E3;
        this.remove(a);
        if (this.h) try {
    ...
    fg.prototype.get = function(a, b) {
        ...
        if (d && (c = qc.get("" + a, void 0)) && (c = unescape(c), b)) try {
            c = JSON.parse(c)
        } catch (e) {
    ...
    function ig(a, b, c, d) {
        ...
        hg().set("nextId", d + 1, 86400, !0);
        hg().set("requests", e, 86400, !0);
        return d
    }

    function jg(a) {
        var b = hg().get("requests", !0) || {};
        delete b[a];
        hg().set("requests", b, 86400, !0)
    }
        ...
        if (b) {
            for (var c in b) {
                ...
                if (!(6E4 > Math.round(T()) - d.requestTime)) {
                    var e = d.authState,
                        f = eg(dg(!1));
                    Wa(e, f) && (e = d.request, "requestTimeMs" in e && (e.requestTimeMs = Math.round(T())), $f(a, d.method, e, {}));
                    delete b[c]
                }
            }
            hg().set("requests", b, 86400, !0)
    ...
    var pg = {},
        qg = (pg.AUTH_INVALID = "No user identifier specified.", pg.EXPLICIT_ABORT = "Transaction was explicitly aborted.", pg.IDB_NOT_SUPPORTED = "IndexedDB is not supported.", pg.MISSING_OBJECT_STORE = "Object store not created.", pg.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons.", pg.QUOTA_EXCEEDED = "The current transaction exceeded its quota limitations.", pg.QUOTA_MAYBE_EXCEEDED = "The current transaction may have failed because of exceeding quota limitations.", pg.EXECUTE_TRANSACTION_ON_CLOSED_DB =
            "Can't start a transaction on a closed database", pg),
        rg = {},
        sg = (rg.AUTH_INVALID = "ERROR", rg.EXECUTE_TRANSACTION_ON_CLOSED_DB = "WARNING", rg.EXPLICIT_ABORT = "IGNORED", rg.IDB_NOT_SUPPORTED = "ERROR", rg.MISSING_OBJECT_STORE = "ERROR", rg.QUOTA_EXCEEDED = "WARNING", rg.QUOTA_MAYBE_EXCEEDED = "WARNING", rg.UNKNOWN_ABORT = "WARNING", rg);
    ...
    x(tg, V);
    var ug = ["The database connection is closing", "Can't start a transaction on a closed database", "A mutation operation was attempted on a database that did not allow mutations"];

    function vg(a, b, c) {
        if (a instanceof V || a instanceof U) return a;
        if ("QuotaExceededError" === a.name) return new V("QUOTA_EXCEEDED", {
            objectStoreNames: c,
            dbName: b
        });
        if (Nb && "UnknownError" === a.name) return new V("QUOTA_MAYBE_EXCEEDED", {
            objectStoreNames: c,
            dbName: b
        });
        if ("InvalidStateError" === a.name && ug.some(function(d) {
    ...
    W.all = function(a) {
        return new W(function(b, c) {
            ...
            for (var f = {
                    ...
                    G: f.G
                }, ++f.G) yg(W.resolve(a[f.G]).then(function(g) {
                return function(h) {
                    d[g.G] = h;
                    e--;
                    0 === e && b(d)
    ...
    W.prototype.then = function(a, b) {
        var c = this,
            d = null !== a && void 0 !== a ? a : xg,
            e = null !== b && void 0 !== b ? b : wg;
        return new W(function(f, g) {
            "PENDING" === c.state.status ? (c.h.push(function() {
                zg(c, c, d, f, g)
            }), c.onRejected.push(function() {
                Ag(c, c, e, f, g)
            })) : "FULFILLED" === c.state.status ? zg(c, c, d, f, g) : "REJECTED" === c.state.status && Ag(c, c, e, f, g)
        })
    };
    ...
    function zg(a, b, c, d, e) {
        try {
            ...
            f instanceof W ? Bg(a, b, f, d, e) : d(f)
        } catch (g) {
            e(g)
        }
    }
    ...
    r.add = function(a, b, c) {
        return Gg(this, [a], {
            mode: "readwrite",
            I: S("ytidb_transaction_enable_retries_core_and_nwl")
        }, function(d) {
            return Hg(d, a).add(b, c)
        })
    };
    r.clear = function(a) {
        return Gg(this, [a], {
    ...
    function Gg(a, b, c, d) {
        ...
        try {
            ...
            var g = Ig(f, d, e)["catch"](function(h) {
                throw vg(h, a.h.name, b.join());
            })
        } catch (h) {
            g = h instanceof Error ? Promise.reject(vg(h, a.h.name, b.join())) : Promise.reject(vg(Error("unexpected transaction error: " + h), a.h.name, b.join()))
        }
        Jg(a, g, b.join(), e);
        return g
    }
    ...
    function Jg(a, b, c, d) {
        tb(a, function f() {
            ...
            return wa(f, function(p) {
                if (1 == p.h) return g = Math.round(T()), p.l = 2, z(p, b, 4);
                2 != p.h ? (h = Math.round(T()), Kg(k, !0, c, h - g), p.h = 0, p.l = 0) : (l = qa(p), m = Math.round(T()), n = m - g, l instanceof V && ("QUOTA_EXCEEDED" === l.type || "QUOTA_MAYBE_EXCEEDED" === l.type) && og("QUOTA_EXCEEDED", {
                    dbName: k.h.name,
                    objectStoreNames: c,
                    ...
                    transactionCount: k.transactionCount,
                    dbDuration: m - k.j
                }), k.i = !0), Kg(k, !1, c, n), ng || (mg.push({
                    type: "ERROR",
                    payload: l
                }), 10 < mg.length && mg.shift()), p.h = 0)
            })
        })
    }
    ...
    r["delete"] = function(a) {
        return a instanceof IDBKeyRange ? Mg(this, a) : X(this.h["delete"](a))
    };
    r.get = function(a) {
        return X(this.h.get(a))
    };
    r.index = function(a) {
        return new Og(this.h.index(a))
    };
    r.getName = function() {
        return this.h.name
    };
    ...
    function Rg(a, b, c) {
        var d = new Promise(function(e, f) {
            var g = We("ytidb_transaction_try_count", 1),
                h = b(a);
            if (c.I)
                for (var k = 0; k < g - 1; k++) h = yg(h, function(l) {
                    return l instanceof V && "EXPLICIT_ABORT" === l.type ? W.reject(l) : b(a)
                });
            yg(h.then(function(l) {
                a.commit();
                e(l)
            }), f)
        });
    ...
    Og.prototype.count = function(a) {
        return X(this.h.count(a))
    };
    Og.prototype["delete"] = function(a) {
        return Sg(this, {
            query: a
        }, function(b) {
    ...
    Og.prototype.getKey = function(a) {
    ...
    function Ug(a, b, c) {
        return tb(this, function e() {
            ...
            return wa(e, function(w) {
                if (1 == w.h) return f = self.indexedDB.open(a, b), g = c, h = g.blocked, k = g.blocking, l = g.va, m = g.upgrade, n = g.closed, q = function() {
                    p || (p = new Fg(f.result, {
                        closed: n
                    }));
                    return p
                    ...
                    var F = q(),
                        ha = new Qg(f.transaction);
                    m && m(F, y.oldVersion, y.newVersion, ha)
    ...
    Wg.prototype["delete"] = function(a) {
        a = void 0 === a ? {} : a;
        return Vg(this.name, a)
    };
    ...
    function Yg() {
        ...
        if (!a.h) {
            var b = function() {
                ...
                d = function() {
                    return tb(a, function g() {
                        var h = this,
                            k, l, m;
                        return wa(g, function(n) {
                            switch (n.h) {
                                case 1:
                                    return n.l = 2, z(n, Xg(h.name, h.options.version, c), 4);
                                case 4:
                                    k = n.m;
                                    if (!Kb) {
                                        n.h = 5;
                                    ...
                                    a: {
                                        var p = u(Object.keys(h.options.ta));
                                        for (var q = p.next(); !q.done; q = p.next())
                                            if (q = q.value, !k.h.objectStoreNames.contains(q)) {
                                                p = q;
                                                break a
                                            }
                                        p = void 0
                                ...
                                case 2:
                                    m = qa(n);
                                    if (m instanceof DOMException ? "VersionError" === m.name : "DOMError" in self && m instanceof DOMError ? "VersionError" === m.name : m instanceof Object && "message" in m && "An attempt was made to open a database using a lower version than the existing version." === m.message) return n["return"](Xg(h.name, void 0, Object.assign(Object.assign({}, c), {
                                        upgrade: void 0
                                    })));
                                    b();
                                    throw m;
    ...
    function $g(a) {
        return tb(this, function c() {
            ...
            return wa(c, function(e) {
                if (1 == e.h) return z(e, Yg(), 2);
                d = e.m;
                return e["return"](Gg(d, ["databases"], "readwrite", function(f) {
                    var g = Hg(f, "databases");
                    return g.get(a.actualName).then(function(h) {
                        if (h ? a.actualName !== h.actualName || a.publicName !== h.publicName || a.userIdentifier !== h.userIdentifier || a.clearDataOnAuthChange !== h.clearDataOnAuthChange : 1) return X(g.h.put(a, void 0)).then(function() {})
                    })
                }))
            })
        })
        ...
        return tb(this, function b() {
            ...
            return wa(b, function(e) {
                switch (e.h) {
                    case 1:
                        var f;
                        if (f = uf) f = /WebKit\/([0-9]+)/.exec(I), f = !!(f && 600 <= parseInt(f[1], 10));
                        f && (f = /WebKit\/([0-9]+)/.exec(I), f = !(f && 602 <= parseInt(f[1], 10)));
                        if (f && !S("ytidb_allow_on_ios_safari_v8_and_v9") || yb) return e["return"](!1);
                        try {
    ...
    function jh(a) {
        window.addEventListener("online", function() {
            a.l = !0;
            a.i && Cd(a, "ytnetworkstatus-online");
            kh(a);
            if (a.s && S("offline_error_handling")) {
                var b = fh().get("errors", !0);
                if (b) {
                    for (var c in b)
                        if (b[c]) {
                            ...
                            d.name = b[c].name;
                            d.stack = b[c].stack;
                            d.level = b[c].level || b[c].Na;
                            qe(d)
                        }
                    fh().set("errors", {}, 2592E3, !0)
                }
            }
        })
    }
    ...
    function ih(a) {
        window.addEventListener("offline", function() {
            a.l = !1;
            a.i && Cd(a, "ytnetworkstatus-offline");
            kh(a)
        })
    }

    function kh(a) {
        a.u && (re(new U("NetworkStatusManager state did not match poll", T() - 0)), a.u = !1)
    };
    ...
    function lh(a) {
        ...
        this.i.i = !0;
        a.sa && (this.i.s = !0);
        a.R ? (this.R = a.R, td(this.i, "ytnetworkstatus-online", function() {
            mh(b, "publicytnetworkstatus-online")
        }), td(this.i, "ytnetworkstatus-offline", function() {
            mh(b, "publicytnetworkstatus-offline")
        })) : (td(this.i, "ytnetworkstatus-online", function() {
            Cd(b, "publicytnetworkstatus-online")
        }), td(this.i, "ytnetworkstatus-offline", function() {
            Cd(b, "publicytnetworkstatus-offline")
        }))
    }
    x(lh, N);

    function mh(a, b) {
        a.R ? a.l ? (af(a.u), a.u = Ye(function() {
            a.s !== b && (Cd(a, b), a.s = b, a.l = T())
        }, a.R - (T() - a.l))) : (Cd(a, b), a.s = b, a.l = T()) : Cd(a, b)
    };
    var nh;
    ...
    function oh(a, b) {
        ...
        dh().then(function() {
            ...
            nh.i.l !== hh() && re(new U("NetworkStatusManager isOnline does not match window status")); of (a, b)
        })
    }

    function ph(a, b) {
        b = void 0 === b ? {} : b;
        dh().then(function() { of (a, b)
        })
    };
    ...
    function qh(a) {
        var b = this;
        this.h = null;
        a ? this.h = a : cg() && (this.h = Xf());
        Ze(function() {
            kg(b)
        }, 0, 5E3)
    }
    qh.prototype.isReady = function() {
        !this.h && cg() && (this.h = Xf());
        return !!this.h
    };

    function $f(a, b, c, d) {
        !Q("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && re(new U("Missing VISITOR_DATA when sending innertube request.", b, c, d));
        if (!a.isReady()) {
        ...
        a.h.pa && f.headers.Authorization || (l.key = a.h.innertubeApiKey);
        var m = Je("" + g + e, l || {}, !0);
        dh().then(function(n) {
            if (d.retry && S("retry_web_logging_batches") && "www.youtube-nocookie.com" != g) {
                if (S("networkless_gel") && !n || !S("networkless_gel")) var p = ig(b,
                    c, k, h);
                if (p) {
                    var q = f.onSuccess,
                        v = f.onFetchSuccess;
            ...
            try {
                S("use_fetch_for_op_xhr") ? lf(m, f) : S("networkless_gel") && d.retry && !d.Z.bypassNetworkless ? (f.method = "POST", !d.Z.writeThenSend && S("nwl_send_fast_on_unload") ? ph(m, f) : oh(m, f)) : (f.method = "POST", f.postParams || (f.postParams = {}), of (m, f))
            } catch (w) {
                if ("InvalidAccessError" == w.name) p && (jg(p), p = 0), re(Error("An extension is blocking network request."));
                else throw w;
            }
            p && Ze(function() {
                kg(a)
    ...
    function rh(a, b) {
        var c = void 0 === c ? {} : c;
        var d = qh;
        Q("ytLoggingEventsDefaultDisabled", !1) && qh == qh && (d = null);
        c = void 0 === c ? {} : c;
        var e = {};
        e.eventTimeMs = Math.round(c.timestamp || T());
        e[a] = b;
        var f = C("_lact", window);
        f = null == f ? -1 : Math.max(Date.now() - f, 0);
        e.context = {
            lastActivityMs: String(c.timestamp || !isFinite(f) ? -1 : f)
        };
        if (S("log_sequence_info_on_gel_web") && c.ca) {
            f = e.context;
            var g = c.ca;
            ag[g] = g in ag ? ag[g] + 1 : 0;
            f.sequence = {
                index: ag[g],
                groupKey: g
            };
    ...
    function zh(a, b, c, d) {
        if (a)
            if (Array.isArray(a)) {
                var e = d;
                for (d = 0; d < a.length && !(a[d] && (e += Ah(d, a[d], b, c), 500 < e)); d++);
                d = e
            ...
            for (e in a) {
                if (a[e]) {
                    ...
                    var g = a[e],
                        h = b,
                        k = c;
                    f = "string" !== typeof g || "clickTrackingParams" !== f && "trackingParams" !== f ? 0 : (g = xh(atob(g.replace(/-/g, "+").replace(/_/g, "/")))) ? Ah(f + ".ve", g, h, k) : 0;
                    d += f;
                    d += Ah(e, a[e], b, c);
                    if (500 < d) break
                }
            } else c[b] = Bh(a), d += c[b].length;
        else c[b] = Bh(a), d += c[b].length;
        return d
    }
    ...
    function Y(a, b, c) {
        ...
        if (a = "string" === typeof a ? c.getElementById(a) : a)
            if (c = "iframe" == a.tagName.toLowerCase(), b.host || (b.host = c ? ob(a.src) : "https://www.youtube.com"), this.i = new Se(b), c || (b = Ih(this, a), this.o = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.h = a, this.h.id || (this.h.id = "widget" + Ca(this.h)), Me[this.h.id] = this, window.postMessage) {
                this.l = new P;
                Jh(this);
                b = R(this.i, "events");
                for (var d in b) b.hasOwnProperty(d) &&
                    this.addEventListener(d, b[d]);
                for (var e in Oe) Kh(this, e)
            }
    }
    r = Y.prototype;
    ...
    function Ih(a, b) {
        ...
        c.setAttribute("title", "YouTube " + R(a.i, "title"));
        (d = R(a.i, "width")) && c.setAttribute("width", d);
        (d = R(a.i, "height")) && c.setAttribute("height", d);
        var h =
            a.V();
        h.enablejsapi = window.postMessage ? 1 : 0;
        window.location.host && (h.origin = window.location.protocol + "//" + window.location.host);
        h.widgetid = a.m;
        window.location.href && H(["debugjs", "debugcss"], function(k) {
            var l = sb(window.location.href, k);
            null !== l && (h[k] = l)
        });
        c.src = R(a.i, "host") + ("/embed/" + R(a.i, "videoId")) + "?" + qb(h);
        return c
    }
    r.aa = function() {
        this.h && this.h.contentWindow ? this.T({
            event: "listening"
    ...
    function Jh(a) {
        Te(a.i, a, a.m);
        a.j = Be(Ha(a.aa, a));
        ze(a.h, "load", Ha(function() {
            window.clearInterval(this.j);
            this.j = Be(Ha(this.aa, this))
        }, a))
    }

    function Mh(a, b) {
        a.H[b] || (a.H[b] = !0, Nh(a, "addEventListener", [b]))
    }
    r.T = function(a) {
        a.id = this.m;
        a.channel = "widget";
        ...
        if (this.h.contentWindow)
                ...
                if (F.name && "SyntaxError" == F.name) {
                    if (!(F.message && 0 < F.message.indexOf("target origin ''"))) {
                        var d = void 0,
                            e = F;
                        d = void 0 === d ? {} : d;
                        d.name = Q("INNERTUBE_CONTEXT_CLIENT_NAME", 1);
                        d.version = Q("INNERTUBE_CONTEXT_CLIENT_VERSION",
                            void 0);
                        var f = d || {};
                        d = "WARNING";
                        d = void 0 === d ? "ERROR" : d;
                        if (e) {
                            ...
                            if (!(5 <= Dh)) {
                                var k = f,
                                    l = Gh,
                                    m = lc(e);
                                f = m.message || "Unknown Error";
                                g = m.name || "UnknownError";
                                var n = m.stack || e.h || "Not available";
                                n.startsWith(g + ": " +
                                    f) && (h = n.split("\n"), h.shift(), n = h.join("\n"));
                                h = m.lineNumber || "Not available";
                                m = m.fileName || "Not available";
                                var p = void 0,
                                    q = e,
                                    v = 0;
                                if (q.hasOwnProperty("args") && q.args && q.args.length)
                                    for (p = 0; p < q.args.length && !(v = zh(q.args[p], "params." + p, k, v), 500 <= v); p++);
                                ...
                                if (l.length)
                                    for (p = 0; p < l.length && !(v = zh(l[p],
                                            "params.context." + p, k, v), 500 <= v); p++);
                                ...
                                g = Number(e.columnNumber);
                                isNaN(g) || (f.lineNumber = f.lineNumber + ":" + g);
                                if (S("sampleWeight_to_level_migration_killswitch") && void 0 !== e.sampleWeight) e = e.sampleWeight;
                                else if ("IGNORED" === e.level) e = 0;
                                else a: {
                                    e = f;g = vh();h = u(g.i);
                                    for (m = h.next(); !m.done; m = h.next())
                                        if (m = m.value, e.message && e.message.match(m.Oa)) {
                                            e =
                                                m.weight;
                                            break a
                                        }
                                ...
                                for (g = f.next(); !g.done; g = f.next())
                                    if (g = g.value, g.S[e.name])
                                        for (m = u(g.S[e.name]), h = m.next(); !h.done; h = m.next())
                                            if (n = h.value, h = e.message.match(n.regexp)) {
                                                e.params["params.error.original"] = h[0];
                                                m = n.groups;
                                                n = {};
                                                for (k = 0; k < m.length; k++) n[m[k]] = h[k + 1], e.params["params.error." + m[k]] = h[k + 1];
                                                e.message = g.Y(n);
                                                break
                                            }
                                e.params || (e.params = {});
                                ...
                                f = 0 === e.sampleWeight;
                                if (!Ch.has(e.message) && !f) {
                                    "ERROR" === d ? (wh.J("handleError", e), S("record_app_crashed_web") && 0 === Fh && 1 === e.sampleWeight && (Fh++, rh("appCrashed", {
                                            appCrashType: "APP_CRASH_TYPE_BREAKPAD"
                                        })), Eh++) : "WARNING" === d &&
                                        wh.J("handleWarning", e);
                                    if (S("kevlar_gel_error_routing")) {
                                        ...
                                        a: {
                                            ...
                                            for (m = f.next(); !m.done; m = f.next())
                                                if ((n = I) && 0 <= n.toLowerCase().indexOf(m.value.toLowerCase())) {
                                                    f = !0;
                                                    break a
                                                }
                                            f = !1
                                        ...
                                        if (!f) {
                                            ...
                                            g.fileName && (m.filename = g.fileName);
                                            f = g.lineNumber && g.lineNumber.split ? g.lineNumber.split(":") : [];
                                            0 !== f.length && (1 !== f.length || isNaN(Number(f[0])) ? 2 !== f.length || isNaN(Number(f[0])) || isNaN(Number(f[1])) || (m.lineNumber = Number(f[0]), m.columnNumber = Number(f[1])) : m.lineNumber = Number(f[0]));
                                            f = {
                                            ...
                                            Q("FEXP_EXPERIMENTS") && (m.experimentIds = Q("FEXP_EXPERIMENTS"));
                                            if (g = g.params)
                                                for (n = u(Object.keys(g)), k = n.next(); !k.done; k = n.next()) k = k.value, m.kvPairs.push({
                                                    key: "client." + k,
                                                    value: String(g[k])
                                                });
                                            g = Q("SERVER_NAME", void 0);
                                            n = Q("SERVER_VERSION",
                                                void 0);
                                            g && n && (m.kvPairs.push({
                                                key: "server.name",
                                    ...
                                    if (!S("suppress_error_204_logging")) {
                                        g = e;
                                        f = g.params || {};
                                        d = {
                                            urlParams: {
                                        ...
                                        if (d.postParams) {
                                            g.stack &&
                                                (d.postParams.stack = g.stack);
                                            g = u(Object.keys(f));
                                            for (h = g.next(); !h.done; h = g.next()) h = h.value, d.postParams["client." + h] = f[h];
                                            if (f = Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS", void 0))
                                                for (g = u(Object.keys(f)), h = g.next(); !h.done; h = g.next()) h = h.value, d.postParams[h] = f[h];
                                            f = Q("SERVER_NAME", void 0);
                                            g = Q("SERVER_VERSION", void 0);
                                            f && g && (d.postParams["server.name"] = f, d.postParams["server.version"] = g)
                                        } of (Q("ECATCHER_REPORT_HOST", "") + "/error_204", d)
                                    }
                                    Ch.add(e.message);
                                    Dh++
                                }
            ...
            } else console && console.warn &&
                console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")
    };
    ...
    function Qh(a, b) {
        if (D(b))
            for (var c in b) a.playerInfo[c] = b[c]
    }
    ...
    function Rh(a, b) {
        H(b, function(c) {
            this[c] || ("getCurrentTime" == c ? this[c] = function() {
                ...
                return d
            } : Oh(c) ? this[c] = function() {
                this.playerInfo = {};
                this.D = {};
                Nh(this, c, arguments);
                return this
            } : Ph(c) ? this[c] = function() {
                var d = 0;
    ...
    r.getVideoEmbedCode = function() {
        var a = parseInt(R(this.i, "width"), 10),
            b = parseInt(R(this.i, "height"), 10),
            c = R(this.i, "host") + ("/embed/" + R(this.i, "videoId"));
        hb.test(c) && (-1 != c.indexOf("&") && (c = c.replace(bb, "&amp;")), -1 != c.indexOf("<") && (c = c.replace(cb, "&lt;")), -1 != c.indexOf(">") && (c = c.replace(db, "&gt;")), -1 != c.indexOf('"') && (c = c.replace(eb, "&quot;")), -1 != c.indexOf("'") && (c = c.replace(fb, "&#39;")), -1 != c.indexOf("\x00") && (c = c.replace(gb, "&#0;")));
    ...
    r.getOption = function(a, b) {
        if (this.D.namespaces && a && b) return this.D[a][b]
    };
    ...
    Y.prototype.getIframe = Y.prototype.ia;
    ...
    Ne.push(function(a) {
        var b = a;
        b || (b = document);
        a = Ra(b.getElementsByTagName("yt:player"));
        var c = b || document;
        if (c.querySelectorAll && c.querySelector) b = c.querySelectorAll(".yt-player");
            ...
            if (b.querySelectorAll && b.querySelector) b = b.querySelectorAll(".yt-player");
                ...
                for (c = d = 0; b = e[c]; c++) {
                    var g = b.className,
                        h;
                    if (h = "function" == typeof g.split) h = 0 <= Ma(g.split(/\s+/),
                        "yt-player");
                    h && (f[d++] = b)
                }
                f.length = d;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || Pe();
    var Th = B.onYTReady;
    Th && Th();
    var Uh = B.onYouTubeIframeAPIReady;
    Uh && Uh();
    var Vh = B.onYouTubePlayerAPIReady;
    Vh && Vh();
}).call(this);